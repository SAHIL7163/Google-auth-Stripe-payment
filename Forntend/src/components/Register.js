            ...
            {showPassword ?  <FaEye />: <FaEyeSlash/>} 
                     ...
                     <MdOutlineAlternateEmail/>
                        ...
                        <input
                            type='text'
                            className="form-control"
                            placeholder="e.g. Sahil12@gmail.com"
                            id="email"
                        ...
                        <p id="confirmnote" className={emailfocus && !validemail ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            Must match the email-id syntax input field.
                        </p>
                        </div>

                        <button
        className={`btn btn-primary ${!validName || !validPwd || !validMatch || !validemail ? 'disabled' : ''}`}
        type="submit"
